...
<style>
  ...
  .pf-banner.pattern::after {
    ...
    opacity: 0.18;
    background:
      radial-gradient(circle at 18% 30%, var(--c-on-dark) 0 1.4px, transparent 2.4px) 0 0/24px 24px,
      radial-gradient(circle at 60% 80%, var(--c-on-dark) 0 1.4px, transparent 2.4px) 0 0/24px 24px;
  }
