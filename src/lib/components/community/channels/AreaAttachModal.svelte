<script>
  ...
  //
  // NIP-29 group CREATION moved to ChannelCreateWizard (Stufe B4, the "one
  // wizard" merge) — this modal only ATTACHES an existing group now, same as
  // the Concord side always only attached an existing area.
  //
