<!--
  AiLabelIcon — the EU AI Office's round "AI" content label
  (https://digital-strategy.ec.europa.eu/en/policies/eu-icons-labelling-ai-generated-content),
  published for free use without attribution. Disc takes currentColor, the
  letters take the paper token so the mark stays legible on any theme.
-->
...
<Icon {class_} {title} viewBox="89 100 366 366" fill="currentColor" stroke="none">
  <circle cx="272.03" cy="283.47" r="182.74" />
  <g fill="var(--color-base-100, #fff)">
    <path
