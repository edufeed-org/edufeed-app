/**
 * @typedef {'none' | 'login' | 'privateKey' | 'bunker' | 'settings' | 'profile' | 'eventDetails' | 'createCalendar' | 'calendarEvent' | 'signup' | 'createCommunity' | 'editCommunity' | 'webcalQRCode' | 'communityMigration' | 'addBookmark' | 'shareByNaddr' | 'createRoom' | 'joinRoom'} ModalType
 */
